...
<body id="stretch">
            ...
            <div class="row-fluid">
                <div class="span8 offset2">
                    <div id="kotheid-video" class="video-container">
                        <iframe width="627" height="352" src="http://www.youtube.com/embed/wCLsRULp-z0?rel=0" frameborder="0" allowfullscreen></iframe>
    ...
    <section id="walkitout-quote" class="quote-block">
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span10 offset1">
                    <blockquote>
