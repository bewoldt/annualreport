    ...
    <div class="stickem-container">
                ...
                <div class="row">
                    <div class="span8 offset2">
                        <div class="challenge-heading">
                            ...
                            <p class="challenge-bot">Make decisions that support your goals</p>
                        </div>
                    </div>
                    <div class="span4 offset4">
                        <p class="justify challenge-desc">Many UI students are learning to make decisions that affect not only their college experiences, but also their lives beyond the University. The IOWA Challenge urges students to make choices deliberately and thoughtfully, keeping overall goals in sight.</p>
                    </div>
                </div>
            </div>
        </section>
        <section id="leisure-skills" class="video img-block">
            <div class="play">
                ...
                <a class="screencap">
                    <img src="images/leisure-screenshot.jpg" alt="" width="559">
                    <span></span>
                </a>
        ...
        <section id="student-health" class="story">
            <div class="container">
                <div class="row">
                    <div class="span8 offset2">
                        <h1>Student Health Service and Health Iowa: Encouraging Student Health and Safety</h1>
                        <p>For most students, college introduces far more freedom than ever before. Fortunately, the University of Iowa Student Health Service and Health Iowa provide programs that encourage beneficial choices in crucial areas: health and safety.</p>
                        ...
                        <p>Overall, the program was largely successful. JoAnn Daehler-Miller, a dietitian for Health Iowa and current coordinator for the Colorful Choices program noted, “The program had good participation and data shows an increase in the number of fruits and vegetables students ate from the beginning to the end of the program, as well as an increase in the variety of fruits and vegetables they’re choosing.” In addition, there was extensive positive feedback from participants as well, including anonymous comments such as, “I liked that the suggestions were realistic for a college budget and time-frame. This program is conducive to the student lifestyle, and provides people with the information necessary to start making better nutritional choices one step at a time.” Another student remarked, “I like that it was easy to see how many fruits and vegetables you eat and the variety that you consume. I liked the follow up emails and the encouragement in them. I also appreciated the links to further info in those emails.” Due to this success, the program will continue to run during the 2012-2013 school year.</p>
                        ...
                        <p>In order to track the success of the campaign, Health Iowa and UISG staff conducted pre-observation studies in seven areas on campus at different times of day throughout the week of March 26 - March 30, 2012. Tallies of moped riders wearing and not wearing helmets were made. During the month of April, vouchers were distributed and helmet-wearing was encouraged by the Peer Agents, MopedU staff, and Student Health Service staff. Other marketing efforts were made on the Student Health Service website, the Student Health Service e-newsletter, on Cambuses, and on Visix screens at the IMU, CRWC, and Field House. Following these efforts, a post-observation study replicating the original pre-observation study was conducted during the week of April 30 - May 4, 2012.  Please see the table below to see the results of both studies.</p>
                    </div>
                </div>
            </div>
        </section>
        <section id="star-rez" class="story" style="border-top: 1px solid #ddd;">
            <div class="container">
                <div class="row">
                    <div class="span8 offset2">
                        <h1>Choose your college destiny with Star Rez</h1>
                        <p>What if you could pick your roommate based on mutual preferences?</p>
