...
<body id="choose">
    ...
    <section id="student-health" class="container-fluid first-story">
        <div class="row-fluid">
    ...
    <section id="leisure-skills" class="container-fluid video-block">
        <div class="row-fluid">
    ...
    <section id="starrez" class="container-fluid">
        <div class="row-fluid">
            <div class="span10 offset1">
                <header class="header">
