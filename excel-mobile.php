            ...
            <div class="row-fluid">
                <div class="span10 offset1">
                    <div id="iowagrow-video" class="video-container">
                        <iframe width="813" height="457" src="http://www.youtube.com/embed/wCLsRULp-z0?rel=0" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <br>
                    <header class="header">
                            ...
                            <div class="span9 offset3">
                                <div id="readwrite-gallery" class="flexslider">
                                    <ul class="slides">
                                        ...
                                        <li><img src="images/readwrite_slide1.jpg" /></li>
                                        <li><img src="images/readwrite_slide1.jpg" /></li>
                                        <li><img src="images/readwrite_slide1.jpg" /></li>
                                    </ul>
                                </div>
