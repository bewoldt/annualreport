    ...
    <div class="stickem-container">
        ...
        <section id="change-teams" class="story">
            <div class="container">
                <div class="row">
                    <div class="span12">
                        <img src="images/changeteams.jpg" alt="">
                    </div>
                </div>
                <div class="row">
                    <div class="span8 offset2" style="background: #fff;margin-top: -210px;position: relative;z-index:10;box-shadow: 0 1px 1px rgba(0,0,0,.2);border-top: 5px solid #FFCE39;">
                        <div style="padding: 40px;">
                            <h1>Creating Positive<br> Change On Campus</h1>
                    ...
                    <div class="span2">
                        <p class="small" style="margin-top: 20px;"><strong>Pictured above</strong>:<br>
                            Ben Lewis<br>
                            Fill-in Name<br>
                            Fill-in Name<br>
                            Anne Ghinazzi<br>
        ...
        <section id="walkitout" class="story">
            <div class="container">
                <div class="row">
                    <div class="span8 offset2">
                        <div class="heading">
                            <h1 style="color: #fc89ad;">Walk It Out</h1> 
...
padding: 35px 0 0 0;">15<br>student orgs</h4>
                ...
                <div class="row">
                    ...
                    <div class="span4">
                        <div class="highlight">
                            <h4>15</h4>
                            <p>U of I student organizations</p>
                        </div>
                    </div>
                </div>
            -->
            ...
            <div class="container">
                <div class="row">
                    <div class="span2 offset1">
                        <a href="#" id="previous">&larr; Excel</a>
                    </div>
                    <div class="span2 offset6" style="text-align:right;">
                        <a href="#" id="next">Engage &rarr; </a>
                    </div>
                </div>
            </div>
        </section>
