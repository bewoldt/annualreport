...
<body id="stretch">
    ...
    <section id="cultural-centers" class="container-fluid first-story">
        <div class="row-fluid">
    ...
    <section id="kotheid" class="container-fluid video-block">
        <div class="row-fluid">
    ...
    <section id="change-teams" class="container-fluid hero-story">
        <div class="row-fluid">
    ...
    <section id="walkitout-quote" class="container-fluid quote-block">
        <div class="row-fluid">
            <div class="span10 offset1">
                <blockquote>
    ...
    <section id="walkitout" class="container-fluid">
        <div class="row-fluid">
            <div class="span10 offset1">
                <header class="header">
