    ...
    <div class="stickem-container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span4 offset4">
                        <p class="justify challenge-desc">UI students contribute not just to their university, but to their larger communities, too. Service and citizenship offer opportunities for growth, lessons for a lifetime, and feelings of accomplishment.</p>
                    </div>
                </div>
            </div>
        </section>
        <section id="serve-wrac" class="story">
            <div class="container">
                <div class="row">
        ...
        <section id="services-video" class="video img-block">
            <div class="play">
                ...
                <a class="screencap">
                    <img src="images/fair.jpg" alt="" width="559">
                    <span></span>
                </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="span8 offset2">
                        <h1>Fraternity and Sorority Life and Services</h1>
                        ...
                        <p>Specifically, Delta Delta Delta raised $22,000 for St. Jude’s Children’s Hospital in 2011. Another sorority, Zeta Tau Alpha, focused their efforts on Susan G. Komen’s Breast Cancer Foundation, raising $75,000 for the cause.</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="span8 offset2">
                        ...
                        <p>Stats:<br>
                        Animal sanctuary most popular<br>
                        Volunteer opportunities last half a day, one Saturday a month with no commitment<br>
                        20-25 students/opportunity</p>

                        <p>Did you know that Iowa City is the number one city in Iowa and the number three city in the nation for volunteer involvement, according to an article in the Press-Citizen? (source: http://www.press-citizen.com/article/20120914/OPINION03/309140016/Iowans-ready-volunteer-challenge?odyssey=nav%7Chead)</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="span2 offset1">
                        <a href="#" id="previous">&larr; Choose</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
        $(document).ready(function() {
            $('.screencap').click(function() {
                $(this).hide();
                $('#greek-video iframe').attr('src', 'http://www.youtube.com/embed/jt7AF2RCMhg?rel=0&autoplay=1');
            });
        });
    </script>
</body>
