...
<body id="engage" class="body">
    ...
    <div class="stickem-container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span4 offset4">
                        <p class="justify challenge-desc">A University of Iowa education takes place both within and beyond the classroom, and The IOWA Challenge calls on students to be active participants in campus and community life.</p>
                    </div>
                </div>
            </div>
        </section>
        <section id="wrac" class="story">
            <div class="container">
                <div class="row">
                    <div class="span12">
                        <img src="images/wrac.jpg" alt="">
                    </div>
                </div>
                <div class="row">
                    <div class="span8 offset2" style="background: #fff;margin-top: -210px;position: relative;z-index:10;box-shadow: 0 1px 1px rgba(0,0,0,.2);border-top: 5px solid #FFCE39;">
                        <div style="padding: 40px;">
                            <h1>WRAC: Building Up the Young Girls Network</h1>
                            ...
                            <p>“As the week goes on, you really start to see the women flex their skills,” Kroon said. “You can tell these women are gaining confidence in themselves.”</p>
        ...
        <section id="hawkeye-awards" class="video img-block">
            <div class="play">
        ...
        <section id="mentoring" class="video img-block">
            <div class="play">
                <iframe width="560" height="315" src="" frameborder="0" allowfullscreen></iframe>
                <a class="screencap">
                    <img src="images/mentoring-screen.jpg" alt="" width="559">
                    <span></span>
                </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="span2 offset1">
                        <a href="#" id="previous">&larr; Stretch</a>
                    </div>
                    <div class="span2 offset6" style="text-align:right;">
                        <a href="#" id="next">Choose &rarr; </a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
        $(document).ready(function() {
            $('#hawkeye-awards .screencap').click(function() {
                $(this).hide();
                $('#hawkeye-awards iframe').attr('src', 'http://www.youtube.com/embed/90TzDXjWTdo?rel=0&autoplay=1');
            });
            $('#mentoring .screencap').click(function() {
                $(this).hide();
                $('#mentoring iframe').attr('src', 'http://www.youtube.com/embed/90TzDXjWTdo?rel=0&autoplay=1');
            });
        });
    </script>
