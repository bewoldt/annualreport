...
<body id="engage">
    ...
    <section id="wrac" class="container-fluid hero-story first-story">
        <div class="row-fluid">
    ...
    <section id="hawkeye-awards" class="container-fluid video-block">
        <div class="row-fluid">
            <div class="span8 offset2">
    ...
    <section id="pick-one" class="container-fluid">
        <div class="row-fluid">
    ...
    <section id="mentoring" class="container-fluid video-block">
        <div class="row-fluid">
            <div class="span8 offset2">
